// @jarls/shared - Hexagonal coordinate functions
// This file contains all hex coordinate manipulation functions.

import type { AxialCoord, CubeCoord, HexDirection } from './types.js';
...
// ============================================================================
// Key Conversion Functions (for Map storage)
// ============================================================================
