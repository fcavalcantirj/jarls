...
describe('@jarls/shared', () => {
  ...
  // checkThroneVictory tests moved to __tests__/victory-throne.test.ts
  // eliminatePlayer tests moved to __tests__/victory-elimination.test.ts
  // checkLastStanding tests moved to __tests__/victory-laststanding.test.ts
  // checkWinConditions tests moved to __tests__/victory-laststanding.test.ts
